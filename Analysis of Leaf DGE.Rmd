...
# Writing to file
tiff(filename = "Upregulated Genes T1 Leaf Venn2_diagram.tiff", width = 1500);
grid.draw(venn.plot);
dev.off()
```
...
# Writing to file
tiff(filename = "Downregulated Genes T1 Leaf Venn2_diagram.tiff", width = 1500);
grid.draw(venn.plot);
dev.off()
```
...
# Writing to file
tiff(filename = "Upregulated Genes T2 Leaf Venn2_diagram.tiff");
grid.draw(venn.plot);
dev.off()
```
...
# Writing to file
tiff(filename = "Downregulated Genes T2 Leaf Venn2_diagram.tiff");
grid.draw(venn.plot);
dev.off()
```
...
# Writing to file
tiff(filename = "Upregulated Genes T3 Leaf Venn2_diagram.tiff");
grid.draw(venn.plot);
dev.off()
```
...
# Writing to file
tiff(filename = "Downregulated Genes T3 Leaf Venn2_diagram.tiff");
grid.draw(venn.plot);
dev.off()
```
...
T1vsT2_up_s = intersect(T1_sus_up$susL_T1_Up_genes, T2_sus_up$susL_T2_Up_genes)
##write.csv(data.frame(T1vsT2_up_s), file= "Upregulated genes in both T1 and T2 sLeaf.csv", row.names = FALSE)
...
# T2 vs T3
#list of genes shared between conditions
T2vsT3_up_s = intersect(T2_sus_up$susL_T2_Up_genes, T3_sus_up$susL_T3_Up_genes)
#write.csv(data.frame(T2vsT3_up_s), file= "Upregulated genes in both T2 and T3 sLeaf.csv", row.names = FALSE)
#number of genes shared between each set
...
# T1 vs T3
#list of genes shared between conditions
T1vsT3_up_s = intersect(T1_sus_up$susL_T1_Up_genes, T3_sus_up$susL_T3_Up_genes)
#write.csv(data.frame(T1vsT3_up_s), file= "Upregulated genes in both T1 and T3 sLeaf.csv", row.names = FALSE)
#number of genes shared between each set
...
# T1 vs T2 vs T3
T1vsT2vsT3_up_s = intersect(T1_sus_up$susL_T1_Up_genes, T2_sus_up$susL_T2_Up_genes) 
T1vsT2vsT3_up_s = intersect(T1vsT2vsT3_up_s ,T3_sus_up$susL_T3_Up_genes)
#write.csv(data.frame(T1vsT2vsT3_up_s), file= "Downregulated genes in all time.points sLeaf.csv", row.names = FALSE)
...
venn.plot <- draw.triple.venn(
	...
	category = c("Early	Response", 
	  "Late 
	 Response", "Recovery"),
	euler.d = TRUE, 
	scaled = TRUE,
	fill = c("blue", "red", "forestgreen"),
	lty = "blank",
	cex = 2,
	cat.dist = 0.05,
	cat.cex = 1.5,
	cat.col = c("blue", "red", "forestgreen")
	);
...
# Writing to file
tiff(filename = "Suceptible upregulated genes leaf Venn3_diagram.tiff");
grid.draw(venn.plot);
dev.off()
...
# T1 vs T2
#list of genes shared between conditions
T1vsT2_down_s = intersect(T1_sus_down$susL_T1_Down_genes, T2_sus_down$susL_T2_Down_genes)
#write.csv(data.frame(T1vsT2_down_s), file= "downregulated genes in both T1 and T2 sLeaf.csv", row.names = FALSE)
#number of genes shared between each set
...
# T2 vs T3
#list of genes shared between conditions
T2vsT3_down_s = intersect(T2_sus_down$susL_T2_Down_genes, T3_sus_down$susL_T3_Down_genes)
#write.csv(data.frame(T2vsT3_down_s), file= "downregulated genes in both T2 and T3 sLeaf.csv", row.names = FALSE)
#number of genes shared between each set
...
# T1 vs T3
#list of genes shared between conditions
T1vsT3_down_s = intersect(T1_sus_down$susL_T1_Down_genes, T3_sus_down$susL_T3_Down_genes)
#write.csv(data.frame(T1vsT3_down_s), file= "downregulated genes in both T1 and T3 sLeaf.csv", row.names = FALSE)
#number of genes shared between each set
...
# T1 vs T2 vs T3
T1vsT2vsT3_down_s = intersect(T1_sus_down$susL_T1_Down_genes, T2_sus_down$susL_T2_Down_genes) 
T1vsT2vsT3_down_s = intersect(T1vsT2vsT3_down_s ,T3_sus_down$susL_T3_Down_genes)
#write.csv(data.frame(T1vsT2vsT3_down_s), file= "Downregulated genes in all time.points sLeaf.csv", row.names = FALSE)
#number of genes shared between all conditions
...
venn.plot <- grid.arrange(gTree(children=venn.plot), top=textGrob("Downregulated Genes in Drought Susceptible Potatoes", gp=gpar(fontsize=21,font=8)) )

# Writing to file
tiff(filename = "Suceptible downregulated genes Leaf Venn3_diagram.tiff");
grid.draw(venn.plot);
dev.off()
...
# T1 vs T2
#list of genes shared between conditions
T1vsT2_up_t = intersect(T1_tol_up$tolL_T1_Up_genes, T2_tol_up$tolL_T2_Up_genes)
#write.csv(data.frame(T1vsT2_up_t), file= "Upregulated genes in both T1 and T2 tLeaf.csv", row.names = FALSE)
#number of genes shared between each set
...
# T2 vs T3
#list of genes shared between conditions
T2vsT3_up_t = intersect(T2_tol_up$tolL_T2_Up_genes, T3_tol_up$tolL_T3_Up_genes)
#write.csv(data.frame(T2vsT3_up_t), file= "Upregulated genes in both T2 and T3 tLeaf.csv", row.names = FALSE)
#number of genes shared between each set
...
# T1 vs T3
#list of genes shared between conditions
T1vsT3_up_t = intersect(T1_tol_up$tolL_T1_Up_genes, T3_tol_up$tolL_T3_Up_genes)
#write.csv(data.frame(T1vsT3_up_t), file= "Upregulated genes in both T1 and T3 tLeaf.csv", row.names = FALSE)
#number of genes shared between each set
...
# T1 vs T2 vs T3
T1vsT2vsT3_up_t = intersect(T1_tol_up$tolL_T1_Up_genes, T2_tol_up$tolL_T2_Up_genes) 
T1vsT2vsT3_up_t = intersect(T1vsT2vsT3_up_t ,T3_tol_up$tolL_T3_Up_genes)
#write.csv(data.frame(T1vsT2vsT3_up_t), file= "Downregulated genes in all time.points tLeaf.csv", row.names = FALSE)
#number of genes shared between all conditions
...
# Writing to file
tiff(filename = "Tolerant upregulated genes Leaf Venn3_diagram.tiff");
grid.draw(venn.plot);
dev.off()
...
# T1 vs T2
#list of genes shared between conditions
T1vsT2_down_t = intersect(T1_tol_down$tolL_T1_Down_genes, T2_tol_down$tolL_T2_Down_genes)
#write.csv(data.frame(T1vsT2_down_t), file= "downregulated genes in both T1 and T2 tLeaf.csv", row.names = FALSE)
#number of genes shared between each set
...
# T2 vs T3
#list of genes shared between conditions
T2vsT3_down_t = intersect(T2_tol_down$tolL_T2_Down_genes, T3_tol_down$tolL_T3_Down_genes)
#write.csv(data.frame(T2vsT3_down_t), file= "downregulated genes in both T2 and T3 tLeaf.csv", row.names = FALSE)
#number of genes shared between each set
...
# T1 vs T3
#list of genes shared between conditions
T1vsT3_down_t = intersect(T1_tol_down$tolL_T1_Down_genes, T3_tol_down$tolL_T3_Down_genes)
#write.csv(data.frame(T1vsT3_down_t), file= "downregulated genes in both T1 and T3 tLeaf.csv", row.names = FALSE)
#number of genes shared between each set
...
# T1 vs T2 vs T3
T1vsT2vsT3_down_t = intersect(T1_tol_down$tolL_T1_Down_genes, T2_tol_down$tolL_T2_Down_genes) 
T1vsT2vsT3_down_t = intersect(T1vsT2vsT3_down_t ,T3_tol_down$tolL_T3_Down_genes)
#write.csv(data.frame(T1vsT2vsT3_down_t), file= "Downregulated genes in all time.points tLeaf.csv", row.names = FALSE)
#number of genes shared between all conditions
...
# Writing to file
tiff(filename = "Tolerant downregulated genes Venn3_diagram.tiff");
grid.draw(venn.plot);
dev.off()
...
Up_Barchart <- Up_Barchart+scale_fill_brewer(palette="set1")
#save plot
png("Upregulated Differential Gene Expression Barchart Leaf.png")
Up_Barchart
dev.off()
Up_Barchart
...
#save plot
png("Upregulated Differential Gene Expression line Leaf.png")
g
dev.off()
g
```
...
Down_Barchart <- Down_Barchart+scale_fill_brewer(palette="set3")
#save plot
png("Downregulated Differential Gene Expression Barchart Leaf.png")
Down_Barchart
dev.off()
Down_Barchart
...
#save plot
png("Downregulated Differential Gene Expression line Leaf.png")
g
dev.off()
g
```
...
gprofiler_results_ <- gprofiler(query = T1_sus_up, 
                                  organism = "stuberosum", 
                                  ordered_query = F, 
                                  exclude_iea = F, 
                                  max_p_value = 0.05, 
