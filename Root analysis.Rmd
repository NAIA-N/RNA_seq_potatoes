...
Control_up_genes = read.csv("Upregulated_genes_control_Root.csv")

Control_down_genes = read.csv("Downregulated_genes_Control_Root.csv")
...
venn.plot <- draw.pairwise.venn(
	...
	cross.area = length(T2_up_genes_overlap),
	category = c("Late response of Drought Tol", "Late response of Drought sus"),
	fill = c("blue", "red"),
	euler.d = TRUE, 
	scaled = TRUE,
	lty = "blank",
...
grid.newpage();
# Writing to file
tiff(filename = "upregulated genes T2 root Venn2_diagram.tiff", width= 1000, compression = "lzw");
grid.draw(venn.plot);
dev.off()
...
#load data
#T1
T1_seq_s <- read.csv("DEG_sig_results_susceptible_T1_Root.csv")
T1_seq_s_genes <- T1_seq_s$X

#T2
T2_seq_s <- read.csv("DEG_sig_results_susceptible_T2_Root.csv")
#T1
T3_seq_s <- read.csv("DEG_sig_results_susceptible_T3_Root.csv")

#tolerant
#load data
#T1
T1_seq_t <- read.csv("DEG_sig_results_tolerant_T1_Root.csv")
#T2
T2_seq_t <- read.csv("DEG_sig_results_tolerant_T2_Root.csv")
#T1
T3_seq_t <- read.csv("DEG_sig_results_tolerant_T3_Root.csv")
...
T1vsT2_up_genes_overlap_s = intersect(T1_sus_up$susR_T1_Up_genes, T2_sus_up$susR_T2_Up_genes)
write.csv(data.frame(T1vsT2_up_genes_overlap_s), file= "Upregulated_genes in both T1nT2__sRoot.csv", row.names = FALSE)

T1vsT3_up_genes_overlap_s = intersect(T1_sus_up$susR_T1_Up_genes, T3_sus_up$susR_T3_Up_genes)
write.csv(data.frame(T1vsT3_up_genes_overlap_s), file= "Upregulated_genes in both T1nT3__sRoot.csv", row.names = FALSE)

T2vsT3_up_genes_overlap_s = intersect(T2_sus_up$susR_T2_Up_genes, T3_sus_up$susR_T3_Up_genes)
write.csv(data.frame(T2vsT3_up_genes_overlap_s), file= "Downregulated_genes in both T2nT3__sRoot.csv", row.names = FALSE)

T1vsT2vsT3_up_genes_overlap_s = intersect(T1vsT2_up_genes_overlap_s, T3_sus_up$susR_T3_Up_genes)
write.csv(data.frame(T1vsT2vsT3_up_genes_overlap_s), file= "Downregulated_genes in all time.points__sRoot.csv", row.names = FALSE)
...
grid.newpage();
# Writing to file
tiff(filename = "Suceptible_upregulated genes_Venn3_diagram.tiff", width= 800, compression = "lzw");
grid.draw(venn.plot);
dev.off()
...
#list of genes shared between conditions
T1vsT2_down_genes_overlap_s = intersect(T1_sus_down$susR_T1_down_genes, T2_sus_down$susR_T2_down_genes)
write.csv(data.frame(T1vsT2_down_genes_overlap_s), file= "Downregulated_genes in both T1nT2__sRoot.csv", row.names = FALSE)

T1vsT3_down_genes_overlap_s = intersect(T1_sus_down$susR_T1_down_genes, T3_sus_down$susR_T3_down_genes)
write.csv(data.frame(T1vsT3_down_genes_overlap_s), file= "Downregulated_genes in both T1nT3__sRoot.csv", row.names = FALSE)
T2vsT3_down_genes_overlap_s = intersect(T2_sus_down$susR_T2_down_genes, T3_sus_down$susR_T3_down_genes)
write.csv(data.frame(T2vsT3_down_genes_overlap_s), file= "Downregulated_genes in both T2nT3__sRoot.csv", row.names = FALSE)
T1vsT2vsT3_down_genes_overlap_s = intersect(T1vsT2_down_genes_overlap_s, T3_sus_down$susR_T3_down_genes)
write.csv(data.frame(T1vsT2vsT3_down_genes_overlap_s), file= "Downregulated_genes in all time.points__sRoot.csv", row.names = FALSE)
#number of genes shared between each set
...
grid.newpage();
# Writing to file
tiff(filename = "Suceptible_downregulated genes_Venn3_diagram.tiff", width= 800, compression = "lzw");
grid.draw(venn.plot);
dev.off()
...
head(size_T3_tol_up)
#list of genes shared between conditions
T1vsT2_up_genes_overlap_t = intersect(T1_tol_up$tolR_T1_Up_genes, T2_tol_up$tolR_T2_Up_genes)
write.csv(data.frame(T1vsT2_up_genes_overlap_t), file= "Upregulated_genes in T1nT2__tRoot.csv", row.names = FALSE)

T1vsT3_up_genes_overlap_t = intersect(T1_tol_up$tolR_T1_Up_genes, T3_tol_up$tolR_T3_Up_genes)
write.csv(data.frame(T1vsT3_up_genes_overlap_t), file= "Upregulated_genes in T1nT3__tRoot.csv", row.names = FALSE)

T2vsT3_up_genes_overlap_t = intersect(T2_tol_up$tolR_T2_Up_genes, T3_tol_up$tolR_T3_Up_genes)
write.csv(data.frame(T2vsT3_up_genes_overlap_t), file= "Upregulated_genes in T2nT3__tRoot.csv", row.names = FALSE)

T1vsT2vsT3_up_genes_overlap_t = intersect(T1vsT2_up_genes_overlap_s, T1vsT3_up_genes_overlap_t)
write.csv(data.frame(T1vsT2vsT3_up_genes_overlap_t), file= "Upregulated_genes in all time.points__tRoot.csv", row.names = FALSE)
#number of genes shared between each set
...
#grid.newpage();
# Writing to file
#tiff(filename = "Tolarent_upregulated genes_Venn3_diagram.tiff", width= 800, compression = "lzw");
#grid.draw(venn.plot);
#dev.off()
...
#list of genes shared between conditions
T1vsT2_down_genes_overlap_t = intersect(T1_tol_down$tolR_T1_down_genes, T2_tol_down$tolR_T2_down_genes)
write.csv(data.frame(T1vsT2_down_genes_overlap_t), file= "Downregulated_genes in T1nT2__tRoot.csv", row.names = FALSE)

T1vsT3_down_genes_overlap_t = intersect(T1_tol_down$tolR_T1_down_genes, T3_tol_down$tolR_T3_down_genes)
write.csv(data.frame(T1vsT3_down_genes_overlap_t), file= "Downregulated_genes in T1nT3__tRoot.csv", row.names = FALSE)
T2vsT3_down_genes_overlap_t = intersect(T2_tol_down$tolR_T2_down_genes, T3_tol_down$tolR_T3_down_genes)
write.csv(data.frame(T2vsT3_down_genes_overlap_t), file= "Downregulated_genes in T2nT3__tRoot.csv", row.names = FALSE)
T1vsT2vsT3_down_genes_overlap_t = intersect(T1vsT2_down_genes_overlap_t, T3_tol_down$tolR_T3_down_genes)
write.csv(data.frame(T1vsT2vsT3_down_genes_overlap_t), file= "Downregulated_genes in all time.points__tRoot.csv", row.names = FALSE)
#number of genes shared between each set
...
grid.newpage();
# Writing to file
tiff(filename = "Tolarent_downregulated genes_Venn3_diagram.tiff", width= 800, compression = "lzw");
grid.draw(venn.plot);
dev.off()
...
Construct a venn diagram of unique genes to each variety
...
Construct a venn diagram of genes common in both variety
```{r}
